...
jsPsych.plugins['categorize-image'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    display_element.innerHTML = '<center><img id="jspsych-categorize-image-stimulus" class="jspsych-categorize-image-stimulus" src="'+trial.stimulus+'"></img></center>'; //modified JL to be centred
    ...
    function doFeedback(correct, timeout) {
      ...
      if (timeout && !trial.show_feedback_on_timeout) {
        ...
        if (trial.show_stim_with_feedback) {
          display_element.innerHTML = '<center><img id="jspsych-categorize-image-stimulus" class="jspsych-categorize-image-stimulus" src="'+trial.stimulus+'"></img></center>'; // modified by JL to be centred
        }
